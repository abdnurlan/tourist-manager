...
var enumDDL = []string{
	...
	// Added for the 2026 price sheet: city sightseeing and the food masterclass.
	`ALTER TYPE catalog_category ADD VALUE IF NOT EXISTS 'city'`,
	`ALTER TYPE catalog_category ADD VALUE IF NOT EXISTS 'food'`,
