...
export const az = {
  ...
  screen: {
    ...
    event_new: "Yeni event",
    event_edit: "Eventi redaktə et",
    calendar: "Təqvim",
    search: "Axtarış",
    ai: "AI Köməkçi",
    settings: "Tənzimləmələr",
  ...
  empty: {
    ...
    events: {
      title: "Bu turda event yoxdur",
      subtitle: "İlk eventi əlavə edin.",
    },
    today: {
      title: "Bu gün üçün plan yoxdur",
      subtitle: "Bu gün heç bir eventiniz yoxdur. Dincəlin!",
    },
    calendar: {
      title: "Bu aralıqda event yoxdur",
  ...
  toast: {
    ...
    event_created: "Event əlavə edildi.",
    event_updated: "Event yeniləndi.",
    event_deleted: "Event silindi.",
  ...
  settings: {
    ...
    telegram_how_body:
      "Telegram-da botu açın və /start əmrini göndərin. Yalnız sahibin hesabı bota giriş əldə edir. Qoşulduqdan sonra turları və eventləri birbaşa Telegram üzərindən idarə edə bilərsiniz.",
    telegram_never: "Hələ mesaj yoxdur",
    telegram_mode: "Rejim",
    currency: "Defolt valyuta",
    currency_hint:
      "Yeni eventlər üçün ilkin valyuta (yalnız bu cihazda saxlanılır).",
    about_body:
  ...
  ai: {
    ...
    suggestion_4: "Bu həftə restoran eventlərini göstər.",
  ...
  search: {
    placeholder: "Tur, event, məkan, telefon axtarın...",
    tours_group: "Turlar",
    events_group: "Eventlər",
  ...
  aiIntent: {
    ...
    filter_events: "Eventləri süz",
    show_tour_program: "Tur proqramı",
    find_event: "Event tap",
