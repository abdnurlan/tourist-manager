...
export const az = {
  ...
  catalog: {
    ...
    fields: {
      ...
      image_url: "Şəkil",
      image_choose: "Şəkil seç",
      image_change: "Şəkli dəyiş",
      image_remove: "Sil",
      image_uploading: "Yüklənir…",
      image_hint: "JPG, PNG, WEBP, GIF, AVIF · maks. 8 MB",
      image_upload_error: "Şəkil yüklənə bilmədi.",
    ...
    // Qiymət matrisi (2026 cədvəli)
    pricing: {
      title: "Qiymət cədvəli",
      model: "Qiymət modeli",
      model_group_tiers: "Qrup pilləli (1-3 / 4 / 5-7 / 8-10 / 11+)",
      model_flat_per_person: "Nəfərbaşı sabit",
      model_per_vehicle: "Nəqliyyat başına (cip)",
      model_on_request: "Sorğu ilə (qiymət göstərilmir)",
      bracket: "Pillə",
      he: "İvrit dilli",
      std: "İng./Rus dilli",
      basis: "Vahid",
      basis_group: "qrup üçün ümumi",
      basis_per_person: "nəfərbaşı",
      basis_vehicle: "cip başına",
      capacity: "Bir nəqliyyatda maksimum nəfər",
      discount: "Endirim (cipdə {n} nəfər olanda)",
      add_tier: "Pillə əlavə et",
      remove_tier: "Pilləni sil",
      min: "Min nəfər",
      max: "Maks nəfər",
      max_open: "yuxarı hədd yoxdur",
      preview: "Hesablama nümunəsi",
      preview_hint: "Seçilmiş nəfər sayına görə anlıq nəticə",
      required: "Ən azı bir pillə tələb olunur",
      from: "-dan",
      from_label: "Başlanğıc qiymət",
      on_request_short: "Sorğu ilə",
    },
