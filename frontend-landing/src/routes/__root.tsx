...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Səyahət Azərbaycan — Daxili turlar və kəşf marşrutları" },
      ...
      { name: "twitter:title", content: "Səyahət Azərbaycan — Daxili turlar və kəşf marşrutları" },
